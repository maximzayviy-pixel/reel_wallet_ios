-- Создание системы обновления баланса

-- 1. Функция для обновления баланса пользователя на основе ledger
...
-- 2. Функция для обновления баланса по tg_id
...
-- 3. Триггер для автоматического обновления баланса при изменении ledger
...
-- 5. Функция для массового обновления всех балансов
...
-- 6. Обновляем все существующие балансы
...
SELECT 
    ...
    b.ton,
    b.available_rub,
    (COALESCE(b.stars,0)/2 + COALESCE(b.ton,0)*300) as total_rub_calc
FROM users u
